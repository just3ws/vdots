-- after/plugin/abbreviations.lua
-- Neovim Lua version of your autoload/abbreviations.vim
...
local typos = {
  ...
  { "alos", "also" }, { "aslo", "also" },
  { "becuase", "because" },
  { "bianry", "binary" }, { "bianries", "binaries" },
  { "charcter", "character" }, { "charcters", "characters" },
  { "exmaple", "example" }, { "exmaples", "examples" },
  { "shoudl", "should" }, { "seperate", "separate" },
  { "teh", "the" }, { "tpyo", "typo" },
  { "optino", "option" }, { "udpate", "update" },
  { "typdef", "typedef" }, { "flase", "false" },
  { "taht", "that" }, { "resposne", "response" },
}
